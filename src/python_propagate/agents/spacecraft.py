    ...
    def _order_face_properties_box(self):
        ...
        for i, normal in enumerate(self.shape.facets_normal):
            ...
            if normal_tuple in normal_to_property:
                properties_ordered[i] = self.face_properties[normal_to_property[normal_tuple]]
            else:
                raise ValueError(f"Normal vector {normal} does not match any predefined face properties.")
