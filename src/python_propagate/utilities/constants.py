...
SPEEDOFLIGHT = 299792.458  # Speed of light in vacuum in meters per second (m/s)
...
C1 = PHI / SPEEDOFLIGHT  # Constant used in SRP calculations, derived from solar constant and speed of light